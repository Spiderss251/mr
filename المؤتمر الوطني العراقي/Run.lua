...
▀█████████▄           ██       ████████
██▀ │mr ﹏ @KGTBR
│تم تطوير وبرمجة السورس من قبل mrᐂ .
│@KGTBR
#-------------------------------------------------------------------
]]
...
mr = Token:match("(%d+)")
redis:set(mr..":VERSION",1)
redis:set(mr..":SUDO_ID:",SUDO_USER)
redis:set(mr..":DataCenter:",'German')
redis:set(mr..":UserNameBot:",BOT_User)
redis:set(mr..":NameBot:",BOT_NAME)
redis:hset(mr..'username:'..SUDO_USER,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
redis:set("TH3mr_INSTALL","Yes")
info = {} 
...
Bot_User = redis:get(mr..":UserNameBot:")
SUDO_ID = tonumber(redis:get(mr..":SUDO_ID:"))
SUDO_USER = redis:hgetall(mr..'username:'..SUDO_ID).username
version = redis:get(mr..":VERSION")
DataCenter = redis:get(mr..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..mr..')\027[0;32m\n'
...
if msg.type == "pv" and redis:get(mr..':mute_pv:'..msg.chat_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end

if redis:get(mr..'sender:'..msg.sender_user_id_..':flood') then
...
if redis:get(mr..'group:add'..msg.chat_id_) then 
msg.GroupActive = true
else
msg.GroupActive = false
end

if msg.sender_user_id_ == 1381974291 then 
...
msg.TheRank =  'مطور السورس'
msg.Rank = 1
elseif msg.sender_user_id_ == 1407960197 then 
msg.TheRank =  '  مطور السورس '
msg.Rank = 1

elseif msg.sender_user_id_ == 1294933391 then 
msg.TheRank =  ' مطور السورس '
msg.Rank = 1
...
msg.Rank = 1
elseif redis:sismember(mr..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = 'المطور'
msg.TheRank = 'مطور البوت'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(mr..':KARA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء الاساسي'
msg.TheRank = 'المنشىء الاساسي'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(mr..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء'
msg.TheRank = 'المنشىء'
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(mr..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المدير' 
msg.TheRank = 'مدير البوت' 
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(mr..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'الادمن'
msg.TheRank = 'ادمن في البوت'
msg.Rank = 6
elseif msg.GroupActive and redis:sismember(mr..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
...
local lock_bots = redis:get(mr..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(mr..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(mr..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(mr..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(mr..':WELCOME_BOT'),[[• مرحباً انا بوت ]]..redis:get(mr..':NameBot:')..[[ .
...
if msg.GroupActive and redis:get(mr..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
return false 
end
...
if msg.Admin then redis:srem(mr..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.Admin then redis:srem(mr..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(mr..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.mr then 
if msg.text and ScriptFile.imr then
for k, mr in pairs(ScriptFile.mr) do
local SearchText = msg.text:match(mr)
if SearchText then
if not CheckFlood(msg) then
return false 
end

local GetMsg = ScriptFile.imr(msg,{msg.text:match(mr)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",mr.." | Plugin is: \27[1;32mScript.lua\27[0m")
...
if ScriptFile.dmr then
if ScriptFile.dmr(msg) == false then
return false
end
...
if Plug.mr then 
if msg.text and Plug.imr then
for k, mr in pairs(Plug.mr) do
local SearchText = msg.text:match(mr)
if SearchText then
if not CheckFlood(msg) then
return false
...
Mohammad = msg.text
if Mohammad then
if redis:sismember(mr..'CmDlist:'..msg.chat_id_,Mohammad) then
mmdi = redis:hget(mr..'CmD:'..msg.chat_id_,Mohammad)
msg.text = Mohammad:gsub(Mohammad,mmdi)
end
end
local GetMsg = Plug.imr(msg,{msg.text:match(mr)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",mr.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
print("The File "..name.." Not Runing in The Source mr")
end 

end
else
print("The File Script.lua Not Runing in The Source mr")
...
function tdcli_update_callback(data)
	...
	redis:srem(mr..'users',msg.sender_user_id_)
	end
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	mmd = redis:get(mr..":SUDO_ID:")
redis:hset(mr..'username:'..tonumber(mmd),'username',msg.text)
...
download(stk,32)
	...
	if redis:get(mr..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(mr..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(mr..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(mr..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(mr..'admins:'..msg.chat_id_,msg.sender_user_id_)) then 
	msg.Admin = true
	end
	local lock_bots = redis:get(mr..'lock_bots'..msg.chat_id_)
	ISBOT = false
	...
	if ZISBOT and redis:get(mr..'lock_bots_by_kick'..msg.chat_id_) then
	kick_user(msg.sender_user_id_, msg.chat_id_)
	end
...
if redis:get(mr..'lock:join:'..msg.chat_id_) then
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	if redis:get(mr..'group:add'..data.chat_.id_) then
	redis:set(mr..'group:name'..data.chat_.id_,data.chat_.title_)
	end
	...
	if redis:get(mr..'group:add-100'..data.channel_.id_) then
	local linkGroup = (redis:get(mr..'linkGroup-100'..data.channel_.id_) or "")
	local NameGroup = (redis:get(mr..'group:name-100'..data.channel_.id_) or "")
	...
	redis:mset(
	mr..'group:name'..k,IDS.Title,
	mr..'num_msg_mr'..k,5,
	mr..'group:add'..k,true,
	mr..'lock_link'..k,true,
	mr..'lock_spam'..k,true,
	mr..'lock_webpage'..k,true,
	mr..'lock_markdown'..k,true,
	mr..'lock_flood'..k,true,
	mr..'lock_bots'..k,true,
	mr..'mute_forward'..k,true,
	mr..'mute_contact'..k,true,
	mr..'mute_document'..k,true,
	mr..'mute_inline'..k,true,
	mr..'lock_username'..k,true,
	mr..'replay'..k,true
	)
	redis:sadd(mr..'group:ids',k) 

	if IDS.Admins then
	for user,ID in pairs(IDS.Admins) do
	redis:hset(mr..'username:'..ID,'username',user)
	redis:sadd(mr..'admins:'..k,ID)
	end
	end
	if IDS.Creator then
	for user,ID in pairs(IDS.Creator) do
	redis:hset(mr..'username:'..ID,'username',user)
	redis:sadd(mr..':MONSHA_BOT:'..k,ID)
	end
	end
	if IDS.Owner then
	for user,ID in pairs(IDS.Owner) do
	redis:hset(mr..'username:'..ID,'username',user)
	redis:sadd(mr..'owners:'..k,ID)
	end
	end
	end
	io.popen("rm -fr ../.telegram-cli/data/document/*")
	sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'• ** تم رفع النسخه‏‏ الاحتياطيه\n• ** حالياً عدد مجموعاتك هيه‏ *'..redis:scard(mr..'group:ids')..' .*\n')
	end
	elseif data.ID == "UpdateUser" then  
	if data.user_.type_.ID == "UserTypeDeleted" then
	print("¦ userTypeDeleted")
	redis:srem(mr..'users',data.user_.id_)
	elseif data.user_.type_.ID == "UserTypeGeneral" then
	local CheckUser = redis:hgetall(mr..'username:'..data.user_.id_).username
	...
	redis:hset(mr..'username:'..data.user_.id_,'username',USERNAME)
	end 
	end
