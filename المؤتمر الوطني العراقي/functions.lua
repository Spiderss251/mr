...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(kgk..":NameBot:")
...
var =  'مطور السورس'
elseif redis:sismember(kgk..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(kgk..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(kgk..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(kgk..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(kgk..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(kgk..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(kgk..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(kgk..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(kgk..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(kgk..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(kgk..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(kgk..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(kgk..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(kgk..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(kgk..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(kgk..':SUDO_BOT:')
message = '• ** قائمه الـمـطـوريـن : \n\n`• مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(kgk..'username:'..v)
local count = redis:scard(kgk..'mtwr_count'..v)
...
local monsha = redis:smembers(kgk..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n• قائمه المدراء :*\n\n'
local list = redis:smembers(kgk..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(kgk..'admins:'..msg.chat_id_)
...
local list = redis:smembers(kgk..'whitelist:'..msg.chat_id_)
...
if redis:sismember(kgk..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(kgk..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(kgk..'banned:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(kgk..'banned:'..msg.chat_id_)
...
if redis:sismember(kgk..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(kgk..'gban_users')
...
local list = redis:smembers(kgk..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(kgk..':Filter_Word:'..msg.chat_id_,word) then 
return  "• **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(kgk..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(kgk..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(kgk..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(kgk..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(kgk..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(kgk..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(kgk..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
json_data = '{"BotID": '..kgk..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(kgk..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(kgk..'group:name'..GroupS) or '')
...
local admins = redis:smembers(kgk..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(kgk..'username:'..value)
if info then 
...
local creators = redis:smembers(kgk..':MONSHA_BOT:'..GroupS)
if #creators ~= 0 then
...
local creator = redis:smembers(kgk..':KARA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(kgk..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(kgk..'group:ids')
message = '• **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(kgk..'group:name'..v)
if info then 
...
<link href="https://fonts.kgkapis.com/css?family=Harmattan" rel="stylesheet">
...
redis:del(
kgk..'group:add'..id_group,
kgk..'lock_link'..id_group, 
kgk..'lock_id'..id_group,
kgk..'lock_spam'..id_group, 
kgk..'lock_webpage'..id_group,
kgk..'lock_markdown'..id_group,
kgk..'lock_flood'..id_group,
kgk..'lock_bots'..id_group,
kgk..'mute_forward'..id_group,
kgk..'mute_contact'..id_group,
kgk..'mute_location'..id_group,
kgk..'mute_document'..id_group,
kgk..'mute_keyboard'..id_group,
kgk..'mute_game'..id_group,
kgk..'mute_inline'..id_group,
kgk..'lock_username'..id_group,
kgk..'num_msg_kgk'..id_group,
kgk..'replay'..id_group
)
redis:srem(kgk..'group:ids',id_group)
end
...
redis:hset(kgk..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(kgk..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
function modadd(msg)
if redis:get(kgk..'lock_service') then
service = true
Get_Director = 30
else
service = false
...
if redis:get(kgk..'group:add'..msg.chat_id_) then  return '• **المجموعة تم تفعيلها مُسبقاً . ' end

local UserChaneel = redis:get(kgk..":UserNameChaneel")
...
redis:setex(kgk..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(kgk..':addnumberusers') or 0)
...
local lock_service = redis:get(kgk..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(kgk..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(kgk..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
kgk..'group:add'..msg.chat_id_,true,
kgk..'lock_link'..msg.chat_id_,true, 
kgk..'lock_id'..msg.chat_id_,true,
kgk..'lock_spam'..msg.chat_id_,true,
kgk..'lock_webpage'..msg.chat_id_,true,
kgk..'lock_markdown'..msg.chat_id_,true,
kgk..'lock_flood'..msg.chat_id_,true,
kgk..'lock_bots'..msg.chat_id_,true,
kgk..'mute_forward'..msg.chat_id_,true,
kgk..'mute_contact'..msg.chat_id_,true,
kgk..'mute_location'..msg.chat_id_,true,
kgk..'mute_document'..msg.chat_id_,true,
kgk..'mute_keyboard'..msg.chat_id_,true,
kgk..'mute_game'..msg.chat_id_,true,
kgk..'mute_inline'..msg.chat_id_,true,
kgk..'lock_username'..msg.chat_id_,true,
kgk..'num_msg_kgk'..msg.chat_id_,5, 
kgk..'replay'..msg.chat_id_,true
)

redis:sadd(kgk..'group:ids',msg.chat_id_) 
redis:sadd(kgk..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(kgk..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(kgk..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(kgk..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(kgk..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(kgk..'username:'..UserID,'username',Resolv)
redis:sadd(kgk..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(kgk..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(kgk..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(kgk..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(kgk..'username:'..UserID,'username',Resolv)
redis:sadd(kgk..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(kgk..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(kgk..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(kgk..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(kgk..'username:'..UserID, 'username', Resolv)
redis:sadd(kgk..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(kgk..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(kgk..'whitelist:'..ChatID,UserID)
...
if redis:sismember(kgk..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(kgk..'username:'..UserID, 'username', Resolv)
redis:sadd(kgk..'owners:'..ChatID,UserID)
...
if redis:sismember(kgk..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(kgk..'username:'..UserID, 'username', Resolv)
redis:sadd(kgk..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(kgk..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(kgk..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(kgk..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(kgk..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(kgk..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(kgk..'username:'..UserID, 'username', Resolv)
redis:sadd(kgk..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(kgk..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(kgk..'banned:'..ChatID,UserID)
...
if redis:sismember(kgk..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(kgk..'username:'..UserID, 'username', Resolv)
redis:sadd(kgk..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(kgk..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(kgk..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(kgk..'username:'..UserID, 'username',Resolv)
redis:sadd(kgk..'gban_users',UserID)
...
redis:srem(kgk..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(kgk..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(kgk..'username:'..UserID, 'username', Resolv)
redis:sadd(kgk..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(kgk..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(kgk..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(kgk..'username:'..UserID, 'username', UserName)
redis:sadd(kgk..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(kgk..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• **العضو » ❪ '..UserName..' ❫\n• **الايدي » ❪ `'..UserID..'` ❫\n• **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(kgk..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(kgk..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المدير\n") 
elseif redis:sismember(kgk..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(kgk..'username:'..UserID, 'username', Resolv)
redis:sadd(kgk..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(kgk..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(kgk..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'• **العضو » '..USERNAME..' \n• ** الايدي » (`'..UserID..'`)\n• **انه بالتأكيد ليس مطور \n') end
redis:srem(kgk..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(kgk..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(kgk..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(kgk..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(kgk..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*•*` اعدادات المجموعه :` \n"
.."\n• التعديل «» "..(redis:get(kgk..'lock_edit'..msg.chat_id_) or 'false')
.."\n• الروابط «» "..(redis:get(kgk..'lock_link'..msg.chat_id_) or 'false')
.."\n• التاك «» "..(redis:get(kgk..'lock_tag'..msg.chat_id_) or 'false')
.."\n• المعرفات «» "..(redis:get(kgk..'lock_username'..msg.chat_id_) or 'false')
.."\n• التكرار «» "..(redis:get(kgk..'lock_flood'..msg.chat_id_) or 'false')
.."\n• الكلايش «» "..(redis:get(kgk..'lock_spam'..msg.chat_id_) or 'false')
.."\n• الويب «» "..(redis:get(kgk..'lock_webpage'..msg.chat_id_) or 'false')
.."\n• الماركدوان «» "..(redis:get(kgk..'lock_markdown'..msg.chat_id_) or 'false')
.."\n• بالطرد البوتات «» "..(redis:get(kgk..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n• البوتات «» "..(redis:get(kgk..'lock_bots'..msg.chat_id_) or 'false')
.."\n• عدد التكرار «» "..(redis:get(kgk..'num_msg_kgk'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n•`اعدادات الوسائط :`\n"
.."\n*• *المتحركه «» "..(redis:get(kgk..'mute_gif'..msg.chat_id_) or 'false')
.."\n• الدردشه «» "..(redis:get(kgk..'mute_text'..msg.chat_id_) or 'false')
.."\n• الانلاين «» "..(redis:get(kgk..'mute_inline'..msg.chat_id_) or 'false')
.."\n• الالعاب «» "..(redis:get(kgk..'mute_game'..msg.chat_id_) or 'false')
.."\n• الصور «» "..(redis:get(kgk..'mute_photo'..msg.chat_id_) or 'false')
.."\n• الفيديو «» "..(redis:get(kgk..'mute_video'..msg.chat_id_) or 'false')
.."\n• البصمات «» "..(redis:get(kgk..'mute_audio'..msg.chat_id_) or 'false')
.."\n• الصوت «» "..(redis:get(kgk..'mute_voice'..msg.chat_id_) or 'false')
.."\n• الملصقات «» "..(redis:get(kgk..'mute_sticker'..msg.chat_id_) or 'false')
.."\n• الجهات «» "..(redis:get(kgk..'mute_contact'..msg.chat_id_) or 'false')
.."\n• التوجيه «» "..(redis:get(kgk..'mute_forward'..msg.chat_id_) or 'false')
.."\n• الموقع «» "..(redis:get(kgk..'mute_location'..msg.chat_id_) or 'false')
.."\n• الملفات «» "..(redis:get(kgk..'mute_document'..msg.chat_id_) or 'false')
.."\n• الاشعارات «» "..(redis:get(kgk..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n• الكيبورد «» "..(redis:get(kgk..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*`اعدادات اخرى : `"
.."\n\n*•*الترحيب «» "..welcomex
.."\n*•*الردود «» "..replayx
...
.."\n*•*الويب «» "..(redis:get(kgk..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*•*الماركدوان «» "..(redis:get(kgk..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*•*البوتات بالطرد «» "..(redis:get(kgk..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*•*البوتات «» "..(redis:get(kgk..'lock_bots'..msg.chat_id_) or 'false')
.."\n*•*عدد التكرار «» "..(redis:get(kgk..'num_msg_kgk'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*اعدادات التقـييد :\n"
.."\n*•*التقييد بالتوجيه «» "..(redis:get(kgk..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالصور «» "..(redis:get(kgk..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالروابط «» "..(redis:get(kgk..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالمتحركه «» "..(redis:get(kgk..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*•*التقييد الفيديو «» "..(redis:get(kgk..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
