...
var =  'مطور السورس'
elseif redis:sismember(mr..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(mr..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(mr..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(mr..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(mr..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(mr..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(mr..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(mr..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(mr..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(mr..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(mr..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(mr..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(mr..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(mr..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(mr..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(mr..':SUDO_BOT:')
message = '• ** قائمه الـمـطـوريـن : \n\n`• مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(mr..'username:'..v)
local count = redis:scard(mr..'mtwr_count'..v)
...
local monsha = redis:smembers(mr..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n• قائمه المدراء :*\n\n'
local list = redis:smembers(mr..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(mr..'admins:'..msg.chat_id_)
...
local list = redis:smembers(mr..'whitelist:'..msg.chat_id_)
...
if redis:sismember(mr..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(mr..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(mr..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(mr..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(mr..'gban_users')
...
local list = redis:smembers(mr..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(mr..':Filter_Word:'..msg.chat_id_,word) then 
return  "• **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(mr..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(mr..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(mr..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(mr..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(mr..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(mr..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(mr..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(mr..'group:ids')
message = '• **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(mr..'group:name'..v)
if info then 
...
<link href="https://fonts.mrapis.com/css?family=Harmattan" rel="stylesheet">
...
redis:del(
mr..'group:add'..id_group,
mr..'lock_link'..id_group, 
mr..'lock_id'..id_group,
mr..'lock_spam'..id_group, 
mr..'lock_webpage'..id_group,
mr..'lock_markdown'..id_group,
mr..'lock_flood'..id_group,
mr..'lock_bots'..id_group,
mr..'mute_forward'..id_group,
mr..'mute_contact'..id_group,
mr..'mute_location'..id_group,
mr..'mute_document'..id_group,
mr..'mute_keyboard'..id_group,
mr..'mute_game'..id_group,
mr..'mute_inline'..id_group,
mr..'lock_username'..id_group,
mr..'num_msg_mr'..id_group,
mr..'replay'..id_group
)
redis:srem(mr..'group:ids',id_group)
end
...
redis:hset(mr..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(mr..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(mr..'group:add'..msg.chat_id_) then  return '• **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(mr..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(mr..':addnumberusers') or 0)
...
local lock_service = redis:get(mr..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(mr..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(mr..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
mr..'group:add'..msg.chat_id_,true,
mr..'lock_link'..msg.chat_id_,true, 
mr..'lock_id'..msg.chat_id_,true,
mr..'lock_spam'..msg.chat_id_,true,
mr..'lock_webpage'..msg.chat_id_,true,
mr..'lock_markdown'..msg.chat_id_,true,
mr..'lock_flood'..msg.chat_id_,true,
mr..'lock_bots'..msg.chat_id_,true,
mr..'mute_forward'..msg.chat_id_,true,
mr..'mute_contact'..msg.chat_id_,true,
mr..'mute_location'..msg.chat_id_,true,
mr..'mute_document'..msg.chat_id_,true,
mr..'mute_keyboard'..msg.chat_id_,true,
mr..'mute_game'..msg.chat_id_,true,
mr..'mute_inline'..msg.chat_id_,true,
mr..'lock_username'..msg.chat_id_,true,
mr..'num_msg_mr'..msg.chat_id_,5, 
mr..'replay'..msg.chat_id_,true
)

redis:sadd(mr..'group:ids',msg.chat_id_) 
redis:sadd(mr..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(mr..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(mr..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(mr..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(mr..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(mr..'username:'..UserID,'username',Resolv)
redis:sadd(mr..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(mr..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(mr..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(mr..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(mr..'username:'..UserID,'username',Resolv)
redis:sadd(mr..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(mr..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(mr..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(mr..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(mr..'username:'..UserID, 'username', Resolv)
redis:sadd(mr..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(mr..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(mr..'whitelist:'..ChatID,UserID)
...
if redis:sismember(mr..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(mr..'username:'..UserID, 'username', Resolv)
redis:sadd(mr..'owners:'..ChatID,UserID)
...
if redis:sismember(mr..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(mr..'username:'..UserID, 'username', Resolv)
redis:sadd(mr..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(mr..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(mr..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(mr..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(mr..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(mr..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(mr..'username:'..UserID, 'username', Resolv)
redis:sadd(mr..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(mr..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(mr..'banned:'..ChatID,UserID)
...
if redis:sismember(mr..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(mr..'username:'..UserID, 'username', Resolv)
redis:sadd(mr..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(mr..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(mr..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(mr..'username:'..UserID, 'username',Resolv)
redis:sadd(mr..'gban_users',UserID)
...
redis:srem(mr..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(mr..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(mr..'username:'..UserID, 'username', Resolv)
redis:sadd(mr..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(mr..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(mr..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(mr..'username:'..UserID, 'username', UserName)
redis:sadd(mr..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(mr..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• **العضو » ❪ '..UserName..' ❫\n• **الايدي » ❪ `'..UserID..'` ❫\n• **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(mr..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(mr..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المدير\n") 
elseif redis:sismember(mr..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(mr..'username:'..UserID, 'username', Resolv)
redis:sadd(mr..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(mr..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(mr..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'• **العضو » '..USERNAME..' \n• ** الايدي » (`'..UserID..'`)\n• **انه بالتأكيد ليس مطور \n') end
redis:srem(mr..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(mr..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(mr..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(mr..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(mr..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*•*` اعدادات المجموعه :` \n"
.."\n• التعديل «» "..(redis:get(mr..'lock_edit'..msg.chat_id_) or 'false')
.."\n• الروابط «» "..(redis:get(mr..'lock_link'..msg.chat_id_) or 'false')
.."\n• التاك «» "..(redis:get(mr..'lock_tag'..msg.chat_id_) or 'false')
.."\n• المعرفات «» "..(redis:get(mr..'lock_username'..msg.chat_id_) or 'false')
.."\n• التكرار «» "..(redis:get(mr..'lock_flood'..msg.chat_id_) or 'false')
.."\n• الكلايش «» "..(redis:get(mr..'lock_spam'..msg.chat_id_) or 'false')
.."\n• الويب «» "..(redis:get(mr..'lock_webpage'..msg.chat_id_) or 'false')
.."\n• الماركدوان «» "..(redis:get(mr..'lock_markdown'..msg.chat_id_) or 'false')
.."\n• بالطرد البوتات «» "..(redis:get(mr..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n• البوتات «» "..(redis:get(mr..'lock_bots'..msg.chat_id_) or 'false')
.."\n• عدد التكرار «» "..(redis:get(mr..'num_msg_mr'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n•`اعدادات الوسائط :`\n"
.."\n*• *المتحركه «» "..(redis:get(mr..'mute_gif'..msg.chat_id_) or 'false')
.."\n• الدردشه «» "..(redis:get(mr..'mute_text'..msg.chat_id_) or 'false')
.."\n• الانلاين «» "..(redis:get(mr..'mute_inline'..msg.chat_id_) or 'false')
.."\n• الالعاب «» "..(redis:get(mr..'mute_game'..msg.chat_id_) or 'false')
.."\n• الصور «» "..(redis:get(mr..'mute_photo'..msg.chat_id_) or 'false')
.."\n• الفيديو «» "..(redis:get(mr..'mute_video'..msg.chat_id_) or 'false')
.."\n• البصمات «» "..(redis:get(mr..'mute_audio'..msg.chat_id_) or 'false')
.."\n• الصوت «» "..(redis:get(mr..'mute_voice'..msg.chat_id_) or 'false')
.."\n• الملصقات «» "..(redis:get(mr..'mute_sticker'..msg.chat_id_) or 'false')
.."\n• الجهات «» "..(redis:get(mr..'mute_contact'..msg.chat_id_) or 'false')
.."\n• التوجيه «» "..(redis:get(mr..'mute_forward'..msg.chat_id_) or 'false')
.."\n• الموقع «» "..(redis:get(mr..'mute_location'..msg.chat_id_) or 'false')
.."\n• الملفات «» "..(redis:get(mr..'mute_document'..msg.chat_id_) or 'false')
.."\n• الاشعارات «» "..(redis:get(mr..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n• الكيبورد «» "..(redis:get(mr..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*`اعدادات اخرى : `"
.."\n\n*•*الترحيب «» "..welcomex
.."\n*•*الردود «» "..replayx
...
.."\n*•*الويب «» "..(redis:get(mr..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*•*الماركدوان «» "..(redis:get(mr..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*•*البوتات بالطرد «» "..(redis:get(mr..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*•*البوتات «» "..(redis:get(mr..'lock_bots'..msg.chat_id_) or 'false')
.."\n*•*عدد التكرار «» "..(redis:get(mr..'num_msg_mr'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*اعدادات التقـييد :\n"
.."\n*•*التقييد بالتوجيه «» "..(redis:get(mr..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالصور «» "..(redis:get(mr..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالروابط «» "..(redis:get(mr..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالمتحركه «» "..(redis:get(mr..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*•*التقييد الفيديو «» "..(redis:get(mr..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
